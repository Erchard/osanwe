use hex::decode;
use crate::generated::{TransactionType1, TransactionType2};
...
pub fn parse_transaction_type2(
    transaction_hash: &str,
    transaction_type: &str,
    currency_id: &str,
    amount: &str,
    ...
    timestamp: &str,
    recipient_address: &str,
) -> Result<TransactionType2, Box<dyn std::error::Error>> {
    validate_hex_length(transaction_hash, 32)?;
...
mod tests {
    ...
    #[test]
    fn test_parse_transaction_type2() {
        let transaction = parse_transaction_type2(
            "a3b1c2d3e4f5678901234567890abcdef1234567890abcdef1234567890abcde",
            "2",
            "200",
            "75000",
        ...
        assert_eq!(transaction.currency_id, 200);
        assert_eq!(transaction.amount, 75000);
        assert_eq!(transaction.timestamp, 1700000000);
        assert_eq!(transaction.transaction_hash.len(), 32);
